...
```
POST /v1/partner/fetchSettlementList
```
...
```javascript
await axios.post(
  "https://api.upitranzact.com/v1/partner/fetchSettlementList",
  {
...
```json 200
{
    "status": true,
    "statusCode": 200,
    "msg": "Settlements found",
    "data": [
        {
            "amount": "1234.00",
            "UTR": "24149202601040XXXXXXXXX",
            "bankReferenceNumber": "26010410PSCBSXXX",
            "status": "SUCCESS",
            "merchant_id": "UPITRAXXX",
            "initiationDate": "2026-01-04T04:32:42.000Z",
            "created_at": "2026-01-04T06:37:02.000Z"
        },
  	]
}
```
